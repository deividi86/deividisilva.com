    ...
    return (
        <section className="container">
            ...
            <div className="social">             
                <a href="https://github.com/deividi86" className="fa fa-github"></a>
                <a href="https://www.linkedin.com/in/deividisilva/" className="fa fa-linkedin-square"></a>
                <a href="https://stackoverflow.com/users/2146559/deividi-silva" className="fa fa-stack-overflow"></a>
                <a href="mailto:deividi@gmail.com?Subject=Website%20contact" target="_top" className="fa fa-envelope"></a>
            </div>
